// Shader source: https://www.shadertoy.com/view/lt23Dt
...
const fragmentShader = glslify(/* glsl */`
  #define NOISE 3 // Perlin, Worley1, Worley2

  #define PI 3.14159

  // Create uniforms that can be manipulated using Three - @awea 20191109
  uniform vec3 iResolution;
  uniform float iTime;

  // Create a varying (without it this fragment doesn't work on 3D models) - @awea 20191109
  varying vec2 vUv;
